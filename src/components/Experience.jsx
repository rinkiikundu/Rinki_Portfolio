...
const Experience = () => {
  return (
    <div className=" border-neutral-900 pb-4">
        ...
        {{duration:0.5}}className=" my-20 text-center text-4xl"> Experience</motion.h1>
        <div>
            {EXPERIENCES.map((experience,index)=>
            ( <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                <motion.div whileInView={{opacity:1, x:0}} initial ={{opacity:0, x:-100}} tansition={{duration:1}}className="w-full lg:w-1/4">
